...
export function HangingProfile() {
  ...
  return (
    <div ref={containerRef} className="relative w-[300px] h-[350px] flex justify-center -mt-4">
      ...
      >
        <div className="w-20 h-20 rounded-full overflow-hidden border border-foreground/20 mb-3 bg-foreground/5 pointer-events-none group-hover:border-foreground/40 transition-colors duration-300">
          <Image
            src={assetPath("/profile.png")}
            alt="Nicola Amoruso"
            width={80}
            height={80}
            className="h-full w-full object-cover object-center grayscale group-hover:grayscale-0 transition-[filter] duration-500"
            priority
          />
        </div>
